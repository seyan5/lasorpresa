...
if(isset($_POST['form_add_to_cart'])) {
    ...
    else
    {
        ...
        $_SESSION['cart_type_id'][1] = $type_id;
					...
					<div class="row">
						<div class="col-md-5">
							<ul class="prod-slider">
								...
								<li style="background-image: url(assets/uploads/<?php echo $featured_photo; ?>);">
                                    <a class="popup" href="assets/uploads/<?php echo $featured_photo; ?>"></a>
								</li>
                                <?php
							...
							<div id="prod-pager">
								<a data-slide-index="0" href=""><div class="prod-pager-thumb" style="background-image: url(assets/uploads/<?php echo $featured_photo; ?>"></div></a>
                                <?php
                                $i=1;
                                $statement = $pdo->prepare("SELECT * FROM product_photo WHERE p_id=?");
                                $statement->execute(array($_REQUEST['id']));
						...
						<div class="col-md-7">
                            ...
                            <div class="p-quantity">
                                <div class="row">
                                    ...
                                    <div class="col-md-12 mb_20">
                                        ...
                                        <select name="type_id" class="form-control select2" style="width:auto;">
                                            <?php
                                            $statement = $pdo->prepare("SELECT * FROM type");
                                            $statement->execute();
                                            $result = $statement->fetchAll(PDO::FETCH_ASSOC);
                                            foreach ($result as $row) {
                                                if(in_array($row['type_id'],$type)) {
                                                    ?>
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <select name="color_id" class="form-control select2" style="width:auto;">
                                            <?php
                                            $statement = $pdo->prepare("SELECT * FROM color");
                                            $statement->execute();
                                            $result = $statement->fetchAll(PDO::FETCH_ASSOC);
                                            foreach ($result as $row) {
							...
							<div class="p-price">
                                <span style="font-type:14px;"><?php echo LANG_VALUE_54; ?></span><br>
                                <span>
                                    <?php if($p_old_price!=''): ?>
                                        <del><?php echo LANG_VALUE_1; ?><?php echo $p_old_price; ?></del>
                                    <?php endif; ?> 
                                        <?php echo LANG_VALUE_1; ?><?php echo $current_price; ?>
                                </span>
                            </div>
                            <input type="hidden" name="current_price" value="<?php echo $current_price; ?>">
                            <input type="hidden" name="p_name" value="<?php echo $p_name; ?>">
                            <input type="hidden" name="featured_photo" value="<?php echo $featured_photo; ?>">
							<div class="p-quantity">
                                <?php echo LANG_VALUE_55; ?> <br>
								<input type="number" class="input-text qty" step="1" min="1" max="" name="quantity" value="1" title="Qty" type="4" pattern="[0-9]*" inputmode="numeric">
							</div>
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="product-carousel">
                    ...
                    <?php
                    $statement = $pdo->prepare("SELECT * FROM product WHERE ecat_id=? AND p_id!=?");
                    ...
                    foreach ($result as $row) {
                        ...
                        <div class="item">
                            <div class="thumb">
                                <div class="photo" style="background-image:url(assets/uploads/<?php echo $row['featured_photo']; ?>);"></div>
                                <div class="overlay"></div>
                            </div>
                            <div class="text">
                                <h3><a href="product.php?id=<?php echo $row['p_id']; ?>"><?php echo $row['p_name']; ?></a></h3>
                                <h4>
                                    <?php echo LANG_VALUE_1; ?><?php echo $row['current_price']; ?> 
                                ...
                                <div class="rating">
                                    <?php
                                    $t_rating = 0;
                                    $statement1 = $pdo->prepare("SELECT * FROM rating WHERE p_id=?");
