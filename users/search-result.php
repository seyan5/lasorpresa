...
<div class="page-banner" style="background-image: url(admin/uploads/<?php echo $banner_search; ?>);">
...
<div class="page">
    <div class="container">
        <div class="row">
            ...
            $adjacents = 5;
            $statement = $pdo->prepare("SELECT * FROM product WHERE is_active=? AND name LIKE ?");
            ...
            $statement = $pdo->prepare("SELECT * FROM product WHERE is_active=? AND name LIKE ? LIMIT $start, $limit");
            $statement->execute(array(1,$search_text));
            $result = $statement->fetchAll(PDO::FETCH_ASSOC);
                                    ...
                                    <div class="inner">
                                        ...
                                        <div class="text">
                                            ...
                                            <div class="rating">
                                                <?php
                                                $t_rating = 0;
                                                $statement1 = $pdo->prepare("SELECT * FROM rating WHERE id=?");
