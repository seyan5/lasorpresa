    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-7">
                ...
                <form id="floral-customization-form" action="customization-submit.php" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <label for="expected_image">Attach Image:</label>
                        <input type="file" id="expected_image" name="expected_image" class="form-control"
