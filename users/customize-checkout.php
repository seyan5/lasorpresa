    ...
    foreach ($customization as $index => $item): 
        ...
        */
        ...
        if ($item['flower_type'] == 2 && $item['num_flowers'] == 1 && strtolower($item['container_type']) == 1 && strtolower($item['container_color']) == 1) {
            ...
            if ($item['flower_type'] == 2 && $item['num_flowers'] == 2 && strtolower($item['container_type']) == 1 && strtolower($item['container_color']) == 1) {
                $preview_image = ".../images/previews/rose_red_basket2.jpg";
            }
            elseif($item['flower_type'] == 2 && $item['num_flowers'] == 3 && strtolower($item['container_type']) == 1 && strtolower($item['container_color']) == 1){
