...
<h3><?php echo LANG_VALUE_49; ?></h3>
    <div id="left" class="span3">
        ...
        <ul id="menu-group-1" class="nav menu">
            <?php
                $i=0;
                $statement = $pdo->prepare("SELECT * FROM top_category WHERE show_on_menu=1");
                $statement->execute();
                ...
                foreach ($result as $row) {
                    ...
                    <li class="cat-level-1 deeper parent">
                        ...
                        <ul class="children nav-child unstyled small collapse" id="cat-lvl1-id-<?php echo $i; ?>">
                            <?php
                            $j=0;
                            $statement1 = $pdo->prepare("SELECT * FROM mid_category WHERE tcat_id=?");
                            ...
                            foreach ($result1 as $row1) {
                                ...
                                <li class="deeper parent">
                                    ...
                                    <ul class="children nav-child unstyled small collapse" id="cat-lvl2-id-<?php echo $i.$j; ?>">
                                        <?php
                                            $k=0;
                                            $statement2 = $pdo->prepare("SELECT * FROM end_category WHERE mcat_id=?");
