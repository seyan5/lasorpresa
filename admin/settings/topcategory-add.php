...
if(isset($_POST['form1'])) {
    ...
    if($valid == 1) {
		...
		// Saving data into the main table top_category
		$statement = $pdo->prepare("INSERT INTO top_category (tcat_name,show_on_menu) VALUES (?,?)");
...
<section class="content-header">
	...
	<div class="content-header-right">
		<a href="topcategory.php" class="btn btn-primary btn-sm">View All</a>
	</div>
</section>
