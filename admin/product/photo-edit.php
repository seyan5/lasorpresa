...
if(isset($_POST['form1'])) {
    ...
    if($valid == 1) {
        ...
        if(isset($_POST['type'])) {
        	...
        	$statement = $pdo->prepare("DELETE FROM product_type WHERE p_id=?");
					...
					<div class="box-body">
						...
						<div class="form-group">
							...
							<div class="col-sm-4">
								<select name="type[]" class="form-control select2" multiple="multiple">
									...
									foreach ($result as $row) {
										if(isset($type_id)) {
											if(in_array($row['type_id'],$type_id)) {
												$is_select = 'selected';
											} else {
												$is_select = '';
											}
										...
										?>
										<option value="<?php echo $row['type_id']; ?>" <?php echo $is_select; ?>><?php echo $row['type_name']; ?></option>
										<?php
									}
									?>
								</select>
						...
						<div class="form-group">
							...
							<div class="col-sm-4" style="padding-top:4px;">
								<img src="../uploads/<?php echo $p_featured_photo; ?>" alt="" style="width:150px;">
